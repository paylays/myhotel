  ...
  return (
    <section>
      ...
      <div className="bg-whiteSmoke dark:bg-normalBlack py-20 2xl:py-[120px]">
        ...
        {/* Date and rome info */}
        <div
          className="Container bg-white dark:bg-lightBlack  grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 items-center justify-center font-Lora py-3 lg:py-4 xl:py-5 2xl:py-6 border-t-[3px] border-t-khaki  px-5 md:px-7 2xl:px-10"
          data-aos="zoom-in-up"
